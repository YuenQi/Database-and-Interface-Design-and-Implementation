...
<body>
    ...
    <h2 class="center"><b>Film Actors</b></h2>
    ...
    <br>
    <h5>Type in actor ID: </h5>
    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for actor ID..." title="Type in actor ID">

    <table id="myTable">
        <tr class="header">
            <th style="width:30%;">Actor ID</th>
        ...
        if (isset($_POST['order_list'])) {
            $query = "SELECT * FROM film_actor ORDER BY " . $_POST['order_list'];
        }
