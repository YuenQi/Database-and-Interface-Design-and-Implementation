...
if(isset($_POST['submit'])){
    ...
    if(empty($_POST['id'])){
        $errors['id'] = 'Feature Id is required. <br />';
    }
    ...
    if(array_filter($errors)){
        ...
        $sql = "INSERT INTO film_feature (feature_id, film_id, last_update) VALUES ('$id_to_create', '$film_id', '$last_update')";
...
<body>
    ...
    <form action="create_film_feature.php" class="white" method="POST">
