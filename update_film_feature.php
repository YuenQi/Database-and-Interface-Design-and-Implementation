...
if(isset($_POST['submit'])){
    ...
    if(empty($_POST['id'])){
        ...
        $sql_check_id = "SELECT feature_id FROM film_feature WHERE feature_id = $id_to_update";
    ...
    if(empty($_POST['film_id'])){
        $errors['film_id'] = 'Please key in film id. <br />'; 
    }
    else{
    ...
    if(array_filter($errors)){
        ...
        $sql = "UPDATE film_feature SET film_id = '$film_id', last_update = '$last_update' WHERE feature_id = '$id_to_update'";
