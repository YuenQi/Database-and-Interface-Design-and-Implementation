...
if(isset($_POST['submit'])){
    ...
    if(empty($_POST['id'])){
        ...
        $sql_check_id = "SELECT film_id FROM film_category WHERE film_id = $id_to_delete";
    ...
    if(array_filter($errors)){
        ...
        $sql = "DELETE FROM film_category WHERE film_id = $id_to_delete";
...
<body>
    ...
    <form action="#" class="white" method="POST">
        <label>film id that you wish to delete: </label>
