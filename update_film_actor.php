...
if(isset($_POST['submit'])){
    ...
    if(empty($_POST['id'])){
        ...
        $sql_check_id = "SELECT actor_id FROM film_actor WHERE actor_id = $id_to_update";
    ...
    if(array_filter($errors)){
        ...
        $sql = "UPDATE film_actor SET film_id = '$film_id', last_update = '$last_update' WHERE actor_id = '$id_to_update'";
