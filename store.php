...
<body>
    ...
    <form action="store.php" method="POST">
        ...
        <select name="order_list" id="order_list" class="myselect">
            ...
            <option value="manager_staff_id">Manager Staff ID</option>
    ...
    <br><h5>Type in store ID: </h5>
    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for store ID..." title="Type in store ID">

    <table id="myTable">
        <tr class="header">
            <th style="width:20%;">Store ID</th>
            <th style="width:20%;">Manager Staff ID</th>
        ...
        if (isset($_POST['order_list'])){
            $query = "SELECT * FROM store ORDER BY " . $_POST['order_list'] . ", store_id";     
        }
