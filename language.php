...
<body>
    ...
    <h2 class="center"><b>Language</b></h2>
    ...
    <table id="myTable">
        ...
        if (isset($_POST['order_list'])) {
            $query = "SELECT * FROM language ORDER BY " . $_POST['order_list'] . ", language_id";
        }
