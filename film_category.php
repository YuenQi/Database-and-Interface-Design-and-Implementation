...
<body>
    ...
    <h2 class="center"><b>Film Categories</b></h2>
    ...
    <br>
    <h5>Type in category ID: </h5>
    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for category ID..." title="Type in category ID">
    ...
    <table id="myTable">
        ...
        if (isset($_POST['order_list'])) {
            $query = "SELECT * FROM film_category ORDER BY " . $_POST['order_list'];
        }
